...
--
-- Host: bcu8tjtaure2gu5pt2pa-mysql.services.clever-cloud.com:3306
-- Generation Time: May 07, 2023 at 02:46 PM
...
CREATE TABLE `users` (
  ...
  `lastAuthUpdate` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `answers_likes`
--
ALTER TABLE `answers_likes`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `answers_likes`
--
ALTER TABLE `answers_likes`
...
--
ALTER TABLE `answers`
  ADD CONSTRAINT `answers_ibfk_1` FOREIGN KEY (`posts_id`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `answers_ibfk_2` FOREIGN KEY (`postedBy`) REFERENCES `users` (`id`);

--
-- Constraints for table `answers_likes`
--
ALTER TABLE `answers_likes`
  ADD CONSTRAINT `answers_likes_ibfk_1` FOREIGN KEY (`answer_id`) REFERENCES `answers` (`id`),
  ADD CONSTRAINT `answers_likes_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
ALTER TABLE `posts`
  ...
  ADD CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`technology`) REFERENCES `technologies` (`id`);

--
-- Constraints for table `posts_likes`
--
ALTER TABLE `posts_likes`
  ADD CONSTRAINT `posts_likes_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`technologies`) REFERENCES `technologies` (`id`);
COMMIT;
